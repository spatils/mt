...
public class JCIFS_NTLMScheme implements AuthScheme {
   ...
   public JCIFS_NTLMScheme() throws AuthenticationException {
      ...
      try {
         Class.forName("jcifs.ntlmssp.NtlmMessage",false,
   ...
   private class NTLM {
      ...
      */
      ...
      private String generateType1Msg(String host, String domain) {
         jcifs.ntlmssp.Type1Message t1m = new jcifs.ntlmssp.
            Type1Message(jcifs.ntlmssp.Type1Message.getDefaultFlags(),
               domain, host);
      ...
      private String generateType3Msg(String username, String password,
         ...
         try {
            t2m = new jcifs.ntlmssp.
               Type2Message(jcifs.util.Base64.decode(challenge));
         } catch (IOException e) {
            throw new RuntimeException("Invalid Type2 message", e);
         }
 
         jcifs.ntlmssp.Type3Message t3m = new jcifs.ntlmssp.
            Type3Message(t2m, password, domain, username, host, 0);
