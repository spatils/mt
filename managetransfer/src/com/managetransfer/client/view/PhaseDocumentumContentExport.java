...
public class PhaseDocumentumContentExport extends Composite implements HasText {
	...
	private static PhaseDocumentumContentExportUiBinder uiBinder = GWT
			.create(PhaseDocumentumContentExportUiBinder.class);

	interface PhaseDocumentumContentExportUiBinder extends
			UiBinder<Widget, PhaseDocumentumContentExport> {
	}

	public PhaseDocumentumContentExport() {
