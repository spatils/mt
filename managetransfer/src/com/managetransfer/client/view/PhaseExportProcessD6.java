...
public class PhaseExportProcessD6 extends Composite implements HasText {
	@UiField ListBox connectionList;
	@UiField TextArea exportQuery;
	ArrayList<String> connectionListString = new ArrayList<String>();
	private static PhaseExportProcessD6UiBinder uiBinder = GWT
			.create(PhaseExportProcessD6UiBinder.class);

	interface PhaseExportProcessD6UiBinder extends
			UiBinder<Widget, PhaseExportProcessD6> {
	}

	public PhaseExportProcessD6() {
