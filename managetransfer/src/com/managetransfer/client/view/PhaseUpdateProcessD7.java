...
public class PhaseUpdateProcessD7 extends Composite  implements HasText{

	private static PhaseUpdateProcessD7UiBinder uiBinder = GWT
			.create(PhaseUpdateProcessD7UiBinder.class);
	@UiField ListBox connectionList;
	ArrayList<String> connectionListString = new ArrayList<String>();
	interface PhaseUpdateProcessD7UiBinder extends
			UiBinder<Widget, PhaseUpdateProcessD7> {
	}

	public PhaseUpdateProcessD7() {
